...
namespace SpaceInvaders
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
       ...
       public  int kNumberOfRows=3;
		...
		{
          InvaderRows[0] = new InvaderRow("invader1.gif", "invader1.gif", 2 + level);
		  InvaderRows[1] = new InvaderRow("invader2.gif", "invader2.gif", 3 + level);
		  InvaderRows[2] = new InvaderRow("invader2.gif", "invader2.gif", 4 + level);
		  InvaderRows[3] = new InvaderRow("invader3.gif", "invader3.gif", 5 + level);
		  InvaderRows[4] = new InvaderRow("invader3.gif", "invader3.gif", 6 + level);
		}
		...
		static void Main() 
		{
            MessageBox.Show("It has written by MA.OROJLOO \n Email:ma.orojloo@gmail.com \n website:maorojloo.webs.com \n     •☼ BY MA.OROJLOO•☼ ", "about BOX!", MessageBoxButtons.OK, MessageBoxIcon.Information);
